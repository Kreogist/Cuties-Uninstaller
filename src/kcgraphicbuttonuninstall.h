...
#ifndef KCGRAPHICBUTTONUNINSTALL_H
#define KCGRAPHICBUTTONUNINSTALL_H

#include "kcgraphicuninstallbuttonbase.h"

class KCGraphicButtonUninstall : public KCGraphicUninstallButtonBase
{
    Q_OBJECT
public:
    explicit KCGraphicButtonUninstall(QWidget *parent = 0);

};

#endif // KCGRAPHICBUTTONUNINSTALL_H
