...
#ifndef KCGRAPHICBUTTONREPAIR_H
#define KCGRAPHICBUTTONREPAIR_H

#include "kcgraphicuninstallbuttonbase.h"

class KCGraphicButtonRepair : public KCGraphicUninstallButtonBase
{
    Q_OBJECT
public:
    explicit KCGraphicButtonRepair(QWidget *parent = 0);
